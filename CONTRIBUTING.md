# Contributing to the terraform-template-repo
...
9. By participating in this project, you agree to abide by the [Code of Conduct](https://github.com/shankdub/.github/blob/main/CODE_OF_CONDUCT.md).
